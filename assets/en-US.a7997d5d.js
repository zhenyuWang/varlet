...
`)])],-1),b={class:"card"},g=t("h3",null,"Basic Usage",-1),x=t("p",null,[s("When you click the index bar, it will automatically jump to the corresponding "),t("code",null,"IndexAnchor"),s(" anchor position.")],-1),_=t("pre",{class:"hljs"},[t("code",null,[t("span",{class:"hljs-tag"},[s("<"),t("span",{class:"hljs-name"},"var-index-bar"),s(`
