import{_ as s}from"./elevation.7f6c0241.js";import{o as e,c as t,L as a}from"./vendor.ea41cd30.js";const d={components:{}},l={class:"varlet-site-doc"},n=a(`<h1>Uploader</h1><div class="card"><h3>Intro</h3><p>It provides the ability to read files and preview pictures and videos. Get the file upload server by listening for <code>after-read</code> events.</p></div><div class="card"><h3>Install</h3><pre class="hljs"><code><link rel="stylesheet" href="./highlight.css"><span class="hljs-keyword">import</span> { createApp } <span class="hljs-keyword">from</span> <span class="hljs-string">&#39;vue&#39;</span>
...
</code></pre></div><div class="card"><h3>Remove Preprocessing</h3><p>Before deleting the file, the <code>before-remove</code> event is triggered, and a falsy value is returned to prevent the delete operation.</p><pre class="hljs"><code><link rel="stylesheet" href="./highlight.css"> <span class="hljs-tag">&lt;<span class="hljs-name">var-uploader</span> <span class="hljs-attr">v-model</span>=<span class="hljs-string">&quot;files&quot;</span> @<span class="hljs-attr">remove</span>=<span class="hljs-string">&quot;handleBeforeRemove&quot;</span> /&gt;</span>
</code></pre><pre class="hljs"><code><link rel="stylesheet" href="./highlight.css"><span class="hljs-keyword">import</span> { ref } <span class="hljs-keyword">from</span> <span class="hljs-string">&#39;vue&#39;</span>
...
<span class="hljs-keyword">export</span> <span class="hljs-keyword">default</span> {
  <span class="hljs-function"><span class="hljs-title">setup</span>(<span class="hljs-params"></span>)</span> {
    ...
    <span class="hljs-keyword">const</span> handleBeforeRemove = <span class="hljs-keyword">async</span> () =&gt; {
      <span class="hljs-keyword">const</span> action = <span class="hljs-keyword">await</span> Dialog({
        <span class="hljs-attr">title</span>: <span class="hljs-string">&#39;Delete or not?&#39;</span>,
        <span class="hljs-attr">message</span>: <span class="hljs-string">&#39;Cannot be withdrawn after deletion&#39;</span>
      })

      <span class="hljs-keyword">return</span> action === <span class="hljs-string">&#39;confirm&#39;</span>
    }
