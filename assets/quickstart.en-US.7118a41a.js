...
`)])],-1),g={class:"card"},y=s("h3",null,"Webpack/Vite",-1),f=s("pre",{class:"hljs"},[s("code",null,[s("link",{rel:"stylesheet",href:"./highlight.css"}),s("span",{class:"hljs-meta"},"#"),s("span",{class:"bash"}," Install with npm or yarn"),a(`
...
`)])],-1);function w(b,x,V,A,B,N){const l=c("var-site-code-example");return p(),r("div",h,[i,d,j,s("div",m,[_,u,n(l,null,{default:t(()=>[v]),_:1})]),s("div",g,[y,n(l,null,{default:t(()=>[f]),_:1}),n(l,null,{default:t(()=>[k]),_:1})])])}var I=e(o,[["render",w]]);export{I as default};
