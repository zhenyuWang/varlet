...
`)])],-1);function k(y,A,B,C,V,D){const t=l("var-site-code-example");return c(),r("div",d,[h,u,s("div",m,[_,o(t,null,{default:n(()=>[v]),_:1}),o(t,null,{default:n(()=>[j]),_:1})]),s("div",f,[g,b,o(t,null,{default:n(()=>[x]),_:1}),o(t,null,{default:n(()=>[w]),_:1})])])}var T=a(p,[["render",k]]);export{T as default};
