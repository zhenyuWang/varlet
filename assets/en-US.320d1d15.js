...
`)])],-1),_={class:"card"},k=s("h3",null,"Basic Use",-1),f=s("pre",{class:"hljs"},[s("code",null,[s("link",{rel:"stylesheet",href:"./highlight.css"}),s("span",{class:"hljs-tag"},[t("<"),s("span",{class:"hljs-name"},"var-skeleton"),t(),s("span",{class:"hljs-attr"},":loading"),t("="),s("span",{class:"hljs-string"},'"loading"'),t(">")]),t("Loading Data"),s("span",{class:"hljs-tag"},[t("</"),s("span",{class:"hljs-name"},"var-skeleton"),t(">")]),t(`
...
`)])],-1),y={class:"card"},b=s("h3",null,"Display Title",-1),w=s("pre",{class:"hljs"},[s("code",null,[s("link",{rel:"stylesheet",href:"./highlight.css"}),s("span",{class:"hljs-tag"},[t("<"),s("span",{class:"hljs-name"},"var-skeleton"),t(),s("span",{class:"hljs-attr"},"title"),t(),s("span",{class:"hljs-attr"},":loading"),t("="),s("span",{class:"hljs-string"},'"loading"'),t(">")]),t("Loading Data"),s("span",{class:"hljs-tag"},[t("</"),s("span",{class:"hljs-name"},"var-skeleton"),t(">")]),t(`
`)])],-1),x={class:"card"},S=s("h3",null,"Custom Rows Height",-1),D=s("pre",{class:"hljs"},[s("code",null,[s("link",{rel:"stylesheet",href:"./highlight.css"}),s("span",{class:"hljs-tag"},[t("<"),s("span",{class:"hljs-name"},"var-skeleton"),t(`
...
`)])],-1),T={class:"card"},z=s("h3",null,"Display Avatar",-1),L=s("pre",{class:"hljs"},[s("code",null,[s("link",{rel:"stylesheet",href:"./highlight.css"}),s("span",{class:"hljs-tag"},[t("<"),s("span",{class:"hljs-name"},"var-skeleton"),t(`
  `),s("span",{class:"hljs-attr"},"title"),t(`
...
>`)]),t(`
	Loading Data
`),s("span",{class:"hljs-tag"},[t("</"),s("span",{class:"hljs-name"},"var-skeleton"),t(">")]),t(`
`)])],-1),A={class:"card"},C=s("h3",null,"Display Card",-1),V=s("pre",{class:"hljs"},[s("code",null,[s("link",{rel:"stylesheet",href:"./highlight.css"}),s("span",{class:"hljs-tag"},[t("<"),s("span",{class:"hljs-name"},"var-skeleton"),t(`
  `),s("span",{class:"hljs-attr"},"title"),t(`
  `),s("span",{class:"hljs-attr"},"avatar"),t(`
