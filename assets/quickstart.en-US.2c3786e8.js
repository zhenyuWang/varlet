...
`)])],-1),v=s("h4",null,"Webpack/Vite",-1),y=s("pre",{class:"hljs"},[s("code",null,[s("link",{rel:"stylesheet",href:"./highlight.css"}),s("span",{class:"hljs-meta"},"#"),s("span",{class:"bash"}," Install with npm, yarn or pnpm"),a(`
...
pnpm add @varlet/ui
`)])],-1),f=s("pre",{class:"hljs"},[s("code",null,[s("link",{rel:"stylesheet",href:"./highlight.css"}),s("span",{class:"hljs-keyword"},"import"),a(" App "),s("span",{class:"hljs-keyword"},"from"),a(),s("span",{class:"hljs-string"},"'./App.vue'"),a(`
...
`)])],-1),k=s("div",{class:"card"},[s("h3",null,"Components Playground"),s("p",null,[a("We provide a web version of the component editor, which is convenient for you to quickly get started with each component of the component library, edit it online, share it with others, or download the code package to run locally. You can click the "),s("code",null,"{...}"),a(" icon in the upper right corner of the page or "),s("a",{href:"https://varlet.gitee.io/varlet-ui-playground"},"go here")])],-1);function w(b,x,V,A,B,C){const n=c("var-site-code-example");return p(),o("div",h,[i,d,s("div",m,[u,j,_,l(n,null,{default:t(()=>[g]),_:1}),v,l(n,null,{default:t(()=>[y]),_:1}),l(n,null,{default:t(()=>[f]),_:1})]),k])}var I=e(r,[["render",w]]);export{I as default};
