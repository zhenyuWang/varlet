import{_ as n}from"./elevation.85e837d8.js";import{e as d,o as c,c as o,a as t,i as l,j as e,m as s,U as r}from"./vendor.6bd64832.js";const h={components:{}},p={class:"varlet-site-doc"},i=t("h1",null,"Select",-1),j={class:"card"},g=t("h3",null,"Install",-1),u=t("pre",{class:"hljs"},[t("code",null,[t("span",{class:"hljs-keyword"},"import"),s(" { createApp } "),t("span",{class:"hljs-keyword"},"from"),s(),t("span",{class:"hljs-string"},"'vue'"),s(`
...
`)])],-1),y=t("pre",{class:"hljs"},[t("code",null,[t("span",{class:"hljs-tag"},[s("<"),t("span",{class:"hljs-name"},"var-select"),s(),t("span",{class:"hljs-attr"},"placeholder"),s("="),t("span",{class:"hljs-string"},'"Please select one the options"'),s(),t("span",{class:"hljs-attr"},"v-model"),s("="),t("span",{class:"hljs-string"},'"value"'),s(">")]),s(`
...
`)])],-1),f={class:"card"},S=t("h3",null,"Plain Mode",-1),x=t("p",null,"If you only need the basic functionality of the component, you can remove some styles through attributes.",-1),k=t("pre",{class:"hljs"},[t("code",null,[t("span",{class:"hljs-tag"},[s("<"),t("span",{class:"hljs-name"},"var-select"),s(` 
