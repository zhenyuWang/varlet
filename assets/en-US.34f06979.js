import{_ as e}from"./elevation.f7de2a7a.js";import{e as c,o as h,c as p,a,i as n,j as t,m as s,U as o}from"./vendor.efca09d3.js";const r={components:{}},j={class:"varlet-site-doc"},d=a("h1",null,"Menu",-1),i=a("div",{class:"card"},[a("h3",null,"Intro"),a("p",null,"Enable elements to display a menu when clicked, freely control the display position of the menu by controlling the alignment and offset of the menu.")],-1),m={class:"card"},g=a("h3",null,"Install",-1),u=a("pre",{class:"hljs"},[a("code",null,[a("link",{rel:"stylesheet",href:"./highlight.css"}),a("span",{class:"hljs-keyword"},"import"),s(" { createApp } "),a("span",{class:"hljs-keyword"},"from"),s(),a("span",{class:"hljs-string"},"'vue'"),s(`
`),a("span",{class:"hljs-keyword"},"import"),s(" { Menu } "),a("span",{class:"hljs-keyword"},"from"),s(),a("span",{class:"hljs-string"},"'@varlet/ui'"),s(`

createApp().use(Menu)
`)])],-1),f=a("div",{class:"card"},[a("h3",null,"Attention"),a("p",null,[s("Menu is an "),a("code",null,"inline block"),s(" element. When you click through the default slot, the menu will be displayed. If you want menu to monopolize a line, it is recommended to package a "),a("code",null,"block"),s(" element Menu is automatically closed in the area beyond the scope of the component, so you can\u2019t use the same state to bind "),a("code",null,"v-model:show"),s(". Otherwise, when the display is triggered, other menu pairs are also triggered Menu cannot be displayed due to the modification of "),a("code",null,"v-model:show"),s(".")])],-1),v={class:"card"},y=a("h3",null,"Alignment Methods",-1),b=a("pre",{class:"hljs"},[a("code",null,[a("link",{rel:"stylesheet",href:"./highlight.css"}),a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"div"),s(),a("span",{class:"hljs-attr"},"class"),s("="),a("span",{class:"hljs-string"},'"block"'),s(">")]),s(`
...
`)])],-1),w={class:"card"},M=a("h3",null,"Offset",-1),O=a("pre",{class:"hljs"},[a("code",null,[a("link",{rel:"stylesheet",href:"./highlight.css"}),a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"div"),s(),a("span",{class:"hljs-attr"},"class"),s("="),a("span",{class:"hljs-string"},'"block-1"'),s(">")]),s(`
...
`)])],-1),T=a("pre",{class:"hljs"},[a("code",null,[a("link",{rel:"stylesheet",href:"./highlight.css"}),a("span",{class:"hljs-selector-class"},".block-1"),s(` {
  `),a("span",{class:"hljs-attribute"},"display"),s(`: flex;
  `),a("span",{class:"hljs-attribute"},"justify-content"),s(`: space-between;
}
...
`)])],-1),A={class:"card"},S=a("h3",null,"\u6CE8\u518C\u4E8B\u4EF6",-1),Y=a("pre",{class:"hljs"},[a("code",null,[a("link",{rel:"stylesheet",href:"./highlight.css"}),a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"var-menu"),s(`
