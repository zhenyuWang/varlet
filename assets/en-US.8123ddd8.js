import{_ as s}from"./IconSfc.eb1d27d6.js";import{o as a,c as n,a5 as l}from"./vendor.bac705d4.js";const e={components:{}},t={class:"varlet-site-doc"},p=l(`<h1>Style Provider</h1><p>Component libraries organize styles through <a href="https://developer.mozilla.org/en-US/docs/Web/CSS/Using_CSS_custom_properties">CSS variables</a>. Each component has a corresponding style variable, you can directly replace the style variable on the root node by overriding it with a CSS file. Or use StyleProvider components.</p><div class="card"><h3>Basic style variable</h3><p>Here are some basic style variables for the component library</p><pre class="hljs"><code><link rel="stylesheet" href="./highlight.css"><span class="hljs-selector-pseudo">:root</span> {
