...
`)])],-1),_={class:"card"},f=s("h3",null,"Basic Usage",-1),b=s("p",null,[t("Use "),s("code",null,"time"),t(" to set countdown time(ms).")],-1),y=s("pre",{class:"hljs"},[s("code",null,[s("link",{rel:"stylesheet",href:"./highlight.css"}),s("span",{class:"hljs-tag"},[t("<"),s("span",{class:"hljs-name"},"var-countdown"),t(),s("span",{class:"hljs-attr"},":time"),t("="),s("span",{class:"hljs-string"},'"time"'),t(" />")]),t(`
...
`)])],-1),w={class:"card"},k=s("h3",null,"Custom Format",-1),D=s("p",null,[t("Use "),s("code",null,"format"),t(" to set time text.")],-1),S=s("pre",{class:"hljs"},[s("code",null,[s("link",{rel:"stylesheet",href:"./highlight.css"}),s("span",{class:"hljs-tag"},[t("<"),s("span",{class:"hljs-name"},"var-countdown"),t(),s("span",{class:"hljs-attr"},":time"),t("="),s("span",{class:"hljs-string"},'"time"'),t(),s("span",{class:"hljs-attr"},"format"),t("="),s("span",{class:"hljs-string"},'"DD Day, HH:mm:ss"'),t(" />")]),t(`
`)])],-1),x={class:"card"},C=s("h3",null,"Show Millisecond",-1),H=s("p",null,[t("Use "),s("code",null,"S"),t(" text to show millisecond.")],-1),T=s("pre",{class:"hljs"},[s("code",null,[s("link",{rel:"stylesheet",href:"./highlight.css"}),s("span",{class:"hljs-tag"},[t("<"),s("span",{class:"hljs-name"},"var-countdown"),t(),s("span",{class:"hljs-attr"},":time"),t("="),s("span",{class:"hljs-string"},'"time"'),t(),s("span",{class:"hljs-attr"},"format"),t("="),s("span",{class:"hljs-string"},'"HH:mm:ss:SS"'),t(" />")]),t(`
`)])],-1),U={class:"card"},M=s("h3",null,"Custom Style",-1),N=s("p",null,[t("Use "),s("code",null,"slot"),t(" to set custom countdown style.")],-1),$=s("pre",{class:"hljs"},[s("code",null,[s("link",{rel:"stylesheet",href:"./highlight.css"}),s("span",{class:"hljs-tag"},[t("<"),s("span",{class:"hljs-name"},"var-countdown"),t(),s("span",{class:"hljs-attr"},":time"),t("="),s("span",{class:"hljs-string"},'"time"'),t(">")]),t(`
...
`)])],-1),R={class:"card"},E=s("h3",null,"Manual Control",-1),A=s("p",null,[t("Use "),s("code",null,"ref"),t(" to get countdown instance, you can call the "),s("code",null,"start"),t(", "),s("code",null,"pause"),t(", and "),s("code",null,"reset"),t(" methods.")],-1),B=s("pre",{class:"hljs"},[s("code",null,[s("link",{rel:"stylesheet",href:"./highlight.css"}),s("span",{class:"hljs-tag"},[t("<"),s("span",{class:"hljs-name"},"var-countdown"),t(`
...
`)])],-1),P=s("pre",{class:"hljs"},[s("code",null,[s("link",{rel:"stylesheet",href:"./highlight.css"}),s("span",{class:"hljs-keyword"},"import"),t(" { ref } "),s("span",{class:"hljs-keyword"},"from"),t(),s("span",{class:"hljs-string"},"'vue'"),t(`
...
`)])],-1),V=s("pre",{class:"hljs"},[s("code",null,[s("link",{rel:"stylesheet",href:"./highlight.css"}),s("span",{class:"hljs-selector-class"},".btn-container"),t(` {
