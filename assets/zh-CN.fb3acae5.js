...
`)])],-1),X=a("pre",{class:"hljs"},[a("code",null,[a("link",{rel:"stylesheet",href:"./highlight.css"}),a("span",{class:"hljs-selector-class"},".block-1"),s(` {
  `),a("span",{class:"hljs-attribute"},"display"),s(`: flex;
  `),a("span",{class:"hljs-attribute"},"justify-content"),s(`: space-between;
}
...
`)])],-1),Y={class:"card"},N=a("h3",null,"\u6CE8\u518C\u4E8B\u4EF6",-1),V=a("pre",{class:"hljs"},[a("code",null,[a("link",{rel:"stylesheet",href:"./highlight.css"}),a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"var-menu"),s(`
