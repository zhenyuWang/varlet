...
/&gt;</span>
</code></pre></div><div class="card"><h3>onRemove</h3><p>Trigger the remove event and obtain the return value to determine whether to delete. If there is a true return value, the delete update action will not be executed</p><pre class="hljs"><code><link rel="stylesheet" href="./highlight.css"> <span class="hljs-tag">&lt;<span class="hljs-name">var-uploader</span> <span class="hljs-attr">v-model</span>=<span class="hljs-string">&quot;files11&quot;</span> @<span class="hljs-attr">remove</span>=<span class="hljs-string">&quot;handleRemoveFile&quot;</span> /&gt;</span>
</code></pre><pre class="hljs"><code><link rel="stylesheet" href="./highlight.css"><span class="hljs-keyword">import</span> { ref } <span class="hljs-keyword">from</span> <span class="hljs-string">&#39;vue&#39;</span>
...
<span class="hljs-keyword">export</span> <span class="hljs-keyword">default</span> {
  <span class="hljs-function"><span class="hljs-title">setup</span>(<span class="hljs-params"></span>)</span> {
    ...
    <span class="hljs-keyword">const</span> handleRemoveFile = <span class="hljs-function">(<span class="hljs-params">file</span>) =&gt;</span> {
        <span class="hljs-comment">//\u90FD\u5C06\u6267\u884C\u5220\u9664\u52A8\u4F5C,\u65E0\u8FD4\u56DE\u6216\u8005\u5047\u503C\u6267\u884C\u5220\u9664</span>
        <span class="hljs-comment">//return new Promise.resole(true);</span>
