import{_ as s}from"./IconSfc.7e66d829.js";import{o as e,c as a,a5 as t}from"./vendor.bac705d4.js";const o={components:{}},n={class:"varlet-site-doc"},c=t(`<h1>Browser Adaptation</h1><div class="card"><h3>Intro</h3><p>The component library provides mobile and desktop adaptations, scheme <code>varlet-touch-emulator</code> is used for mobile terminal adaptation, scheme <code>varlet-touch-emulator</code> is used for mobile terminal adaptation.</p></div><div class="card"><h3>Mobile Adaptation</h3><p>The component library design is based on the <code>375px</code> width design draft. It is recommended to use PostCSS plugin to convert <code>px</code> units into <code>vw</code> units to achieve mobile terminal adaptation. Create <code>postcss.config.js</code> under the <code>Webpack/Vite</code> project root path And do the following configuration <code>375px -&gt; 100vw</code></p><pre class="hljs"><code><link rel="stylesheet" href="./highlight.css"><span class="hljs-meta">#</span><span class="bash"> npm</span>
...
</code></pre></div>`,4),p=[c];function r(l,d,i,h,m,u){return e(),a("div",n,p)}var g=s(o,[["render",r]]);export{g as default};
