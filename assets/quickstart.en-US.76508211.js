import{_ as s}from"./elevation.703f44d6.js";import{o as a,c as n,L as p}from"./vendor.ea41cd30.js";const t={components:{}},l={class:"varlet-site-doc"},e=p(`<h1>Quickstart</h1><div class="card"><h3>Intro</h3><p>Here are the most basic ways to access component libraries in common development patterns.</p></div><div class="card"><h3>Install</h3></div><div class="card"><h3>CDN</h3><p><code>varlet.js</code> contain all the styles and logic of the component library, and you can import them.</p><pre class="hljs"><code><link rel="stylesheet" href="./highlight.css"><span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">id</span>=<span class="hljs-string">&quot;app&quot;</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
