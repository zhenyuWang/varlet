...
`)])],-1),k=s("p",null,[e("\u6CE8\u5165\u7EC4\u4EF6\u5E93\u63A8\u8350\u7684"),s("code",null,"\u6587\u5B57\u989C\u8272"),e("\u548C"),s("code",null,"\u80CC\u666F\u989C\u8272"),e("\u53D8\u91CF\u6765\u63A7\u5236\u6574\u4F53\u989C\u8272")],-1),g=s("pre",{class:"hljs"},[s("code",null,[s("link",{rel:"stylesheet",href:"./highlight.css"}),s("span",{class:"hljs-selector-tag"},"body"),e(` {
...
`)])],-1);function f(v,y,b,w,x,T){const l=o("var-site-code-example");return c(),r("div",p,[i,d,s("div",u,[j,a(l,null,{default:t(()=>[_]),_:1}),a(l,null,{default:t(()=>[m]),_:1}),k,a(l,null,{default:t(()=>[g]),_:1})])])}var B=n(h,[["render",f]]);export{B as default};
