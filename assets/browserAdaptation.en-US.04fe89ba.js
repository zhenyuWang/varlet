...
`)])],-1),k=s("pre",{class:"hljs"},[s("code",null,[s("link",{rel:"stylesheet",href:"./highlight.css"}),s("span",{class:"hljs-keyword"},"import"),e(),s("span",{class:"hljs-string"},"'@varlet/touch-emulator'"),e(`
`)])],-1);function w(y,A,B,C,S,V){const t=l("var-site-code-example");return c(),r("div",p,[h,u,s("div",m,[_,o(t,null,{default:n(()=>[v]),_:1}),o(t,null,{default:n(()=>[j]),_:1})]),s("div",f,[g,b,o(t,null,{default:n(()=>[x]),_:1}),o(t,null,{default:n(()=>[k]),_:1})])])}var $=a(d,[["render",w]]);export{$ as default};
