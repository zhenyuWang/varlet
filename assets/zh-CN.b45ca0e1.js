...
`)])],-1),b=s("div",{class:"card"},[s("h3",null,"\u8FD0\u884C\u65F6\u4FEE\u6539\u6837\u5F0F"),s("p",null,[l("\u53EF\u80FD\u60A8\u6709\u5728\u7A0B\u5E8F\u8FD0\u884C\u65F6\u66FF\u6362\u6837\u5F0F\u7684\u9700\u6C42\uFF0C\u6BD4\u5982\u4E00\u952E\u6362\u80A4\u4E4B\u7C7B\u7684\uFF0C\u7EC4\u4EF6\u5E93\u63D0\u4F9B\u4E86 StyleProvider \u7EC4\u4EF6\u6765\u8F85\u52A9\u7BA1\u7406\u6837\u5F0F\uFF0C \u7EC4\u4EF6\u63D0\u4F9B\u4E86 "),s("code",null,"\u7EC4\u4EF6\u5F0F\u8C03\u7528"),l(" \u548C "),s("code",null,"\u51FD\u6570\u5F0F\u8C03\u7528"),l(" \u548C\u4E24\u79CD\u8C03\u7528\u65B9\u5F0F\u3002")])],-1),y={class:"card"},f=s("h3",null,"\u5F15\u5165",-1),v=s("pre",{class:"hljs"},[s("code",null,[s("link",{rel:"stylesheet",href:"./highlight.css"}),s("span",{class:"hljs-keyword"},"import"),l(" { createApp } "),s("span",{class:"hljs-keyword"},"from"),l(),s("span",{class:"hljs-string"},"'vue'"),l(`
...
`)])],-1),k={class:"card"},w=s("h3",null,"\u5C40\u90E8\u5F15\u5165",-1),x=s("pre",{class:"hljs"},[s("code",null,[s("link",{rel:"stylesheet",href:"./highlight.css"}),s("span",{class:"hljs-keyword"},"import"),l(" { StyleProvider } "),s("span",{class:"hljs-keyword"},"from"),l(),s("span",{class:"hljs-string"},"'@varlet/ui'"),l(`
...
`)])],-1),P=s("pre",{class:"hljs"},[s("code",null,[s("link",{rel:"stylesheet",href:"./highlight.css"}),s("span",{class:"hljs-keyword"},"import"),l(" { ref } "),s("span",{class:"hljs-keyword"},"from"),l(),s("span",{class:"hljs-string"},"'vue'"),l(`
...
`)])],-1),C={class:"card"},N=s("h3",null,"\u51FD\u6570\u5F0F\u8C03\u7528",-1),R=s("p",null,[l("\u51FD\u6570\u5F0F\u7684\u8C03\u7528\u662F\u76F4\u63A5\u66F4\u65B0 "),s("code",null,":root"),l(" \u4E0A\u7684\u53D8\u91CF\uFF0C\u9002\u5408\u9700\u8981\u5168\u5C40\u66F4\u65B0\u6837\u5F0F\u7684\u60C5\u51B5\u3002")],-1),$=s("pre",{class:"hljs"},[s("code",null,[s("link",{rel:"stylesheet",href:"./highlight.css"}),s("span",{class:"hljs-tag"},[l("<"),s("span",{class:"hljs-name"},"var-button"),l(),s("span",{class:"hljs-attr"},"type"),l("="),s("span",{class:"hljs-string"},'"primary"'),l(),s("span",{class:"hljs-attr"},"block"),l(" @"),s("span",{class:"hljs-attr"},"click"),l("="),s("span",{class:"hljs-string"},'"toggleRootTheme"'),l(">")]),l("\u5207\u6362\u6839\u8282\u70B9\u6837\u5F0F\u53D8\u91CF"),s("span",{class:"hljs-tag"},[l("</"),s("span",{class:"hljs-name"},"var-button"),l(">")]),l(`
`)])],-1),A=s("pre",{class:"hljs"},[s("code",null,[s("link",{rel:"stylesheet",href:"./highlight.css"}),s("span",{class:"hljs-keyword"},"export"),l(),s("span",{class:"hljs-keyword"},"default"),l(` {
  `),s("span",{class:"hljs-function"},[s("span",{class:"hljs-title"},"setup"),l("("),s("span",{class:"hljs-params"}),l(")")]),l(` {
...
`)])],-1),B=h('<h2>API</h2><div class="card"><h3>\u5C5E\u6027</h3><table><thead><tr><th>\u53C2\u6570</th><th>\u8BF4\u660E</th><th>\u7C7B\u578B</th><th>\u9ED8\u8BA4\u503C</th></tr></thead><tbody><tr><td><code>style-vars</code></td><td>css \u53D8\u91CF</td><td><em>Record&lt;string, string&gt;</em></td><td><code>{}</code></td></tr></tbody></table></div><div class="card"><h3>\u63D2\u69FD</h3><table><thead><tr><th>\u63D2\u69FD\u540D</th><th>\u8BF4\u660E</th><th>\u53C2\u6570</th></tr></thead><tbody><tr><td><code>default</code></td><td>\u7EC4\u4EF6\u5185\u5BB9</td><td><code>-</code></td></tr></tbody></table></div>',3);function U(E,I,W,q,D,F){const a=c("var-site-code-example");return r(),o("div",i,[d,j,s("div",u,[m,_,n(a,null,{default:t(()=>[g]),_:1})]),b,s("div",y,[f,n(a,null,{default:t(()=>[v]),_:1})]),s("div",k,[w,n(a,null,{default:t(()=>[x]),_:1})]),s("div",S,[z,V,n(a,null,{default:t(()=>[T]),_:1}),n(a,null,{default:t(()=>[P]),_:1})]),s("div",C,[N,R,n(a,null,{default:t(()=>[$]),_:1}),n(a,null,{default:t(()=>[A]),_:1})]),B])}var J=e(p,[["render",U]]);export{J as default};
