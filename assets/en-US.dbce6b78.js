...
`)])],-1);function f(y,v,b,T,w,x){const l=o("var-site-code-example");return r(),c("div",i,[d,p,s("div",u,[m,a(l,null,{default:t(()=>[j]),_:1}),a(l,null,{default:t(()=>[_]),_:1}),g,a(l,null,{default:t(()=>[k]),_:1})])])}var N=n(h,[["render",f]]);export{N as default};
