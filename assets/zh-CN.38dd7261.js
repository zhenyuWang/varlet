...
`)])],-1),m={class:"card"},_=s("h3",null,"\u57FA\u672C\u4F7F\u7528",-1),v=s("pre",{class:"hljs"},[s("code",null,[s("link",{rel:"stylesheet",href:"./highlight.css"}),s("span",{class:"hljs-tag"},[t("<"),s("span",{class:"hljs-name"},"var-uploader"),t(),s("span",{class:"hljs-attr"},"v-model"),t("="),s("span",{class:"hljs-string"},'"files"'),t(" @"),s("span",{class:"hljs-attr"},"after-read"),t("="),s("span",{class:"hljs-string"},'"handleAfterRead"'),t("/>")]),t(`
...
`)])],-1),k={class:"card"},b=s("h3",null,"\u6587\u4EF6\u9884\u89C8",-1),w=s("p",null,"\u901A\u8FC7\u5206\u6790\u6587\u4EF6\u7684url\u540E\u7F00\u540D\u5224\u65AD\u6587\u4EF6\u7C7B\u578B\uFF0C\u652F\u6301\u56FE\u7247\u548C\u89C6\u9891\u9884\u89C8\u3002",-1),x=s("pre",{class:"hljs"},[s("code",null,[s("link",{rel:"stylesheet",href:"./highlight.css"}),s("span",{class:"hljs-tag"},[t("<"),s("span",{class:"hljs-name"},"var-uploader"),t(),s("span",{class:"hljs-attr"},"v-model"),t("="),s("span",{class:"hljs-string"},'"files"'),t("/>")]),t(`
`)])],-1),V=s("pre",{class:"hljs"},[s("code",null,[s("link",{rel:"stylesheet",href:"./highlight.css"}),s("span",{class:"hljs-keyword"},"import"),t(" { ref } "),s("span",{class:"hljs-keyword"},"from"),t(),s("span",{class:"hljs-string"},"'vue'"),t(`
...
`)])],-1),C={class:"card"},N=s("h3",null,"\u6587\u4EF6\u6570\u91CF\u9650\u5236",-1),S=s("pre",{class:"hljs"},[s("code",null,[s("link",{rel:"stylesheet",href:"./highlight.css"}),s("span",{class:"hljs-tag"},[t("<"),s("span",{class:"hljs-name"},"var-uploader"),t(),s("span",{class:"hljs-attr"},"v-model"),t("="),s("span",{class:"hljs-string"},'"files"'),t(),s("span",{class:"hljs-attr"},":maxlength"),t("="),s("span",{class:"hljs-string"},'"1"'),t("/>")]),t(`
`)])],-1),E={class:"card"},U=s("h3",null,"\u6587\u4EF6\u5927\u5C0F\u9650\u5236",-1),$=s("p",null,[t("\u8D85\u8FC7\u9650\u5236\u4F1A\u88AB\u963B\u6B62\u8BFB\u53D6\uFF0C\u53EF\u4EE5\u901A\u8FC7\u76D1\u542C"),s("code",null,"oversize"),t("\u4E8B\u4EF6\u83B7\u53D6\u6587\u4EF6\u3002")],-1),P=s("pre",{class:"hljs"},[s("code",null,[s("link",{rel:"stylesheet",href:"./highlight.css"}),s("span",{class:"hljs-tag"},[t("<"),s("span",{class:"hljs-name"},"var-uploader"),t(),s("span",{class:"hljs-attr"},"v-model"),t("="),s("span",{class:"hljs-string"},'"files"'),t(),s("span",{class:"hljs-attr"},":maxsize"),t("="),s("span",{class:"hljs-string"},'"1024"'),t(" @"),s("span",{class:"hljs-attr"},"oversize"),t("="),s("span",{class:"hljs-string"},'"handleOversize"'),t(" />")]),t(`
`)])],-1),T=s("pre",{class:"hljs"},[s("code",null,[s("link",{rel:"stylesheet",href:"./highlight.css"}),s("span",{class:"hljs-keyword"},"import"),t(" { ref } "),s("span",{class:"hljs-keyword"},"from"),t(),s("span",{class:"hljs-string"},"'vue'"),t(`

`),s("span",{class:"hljs-keyword"},"export"),t(),s("span",{class:"hljs-keyword"},"default"),t(` {
  `),s("span",{class:"hljs-function"},[s("span",{class:"hljs-title"},"setup"),t("("),s("span",{class:"hljs-params"}),t(")")]),t(` {
    `),s("span",{class:"hljs-keyword"},"const"),t(` files = ref([])

    `),s("span",{class:"hljs-keyword"},"const"),t(" handleOversize = "),s("span",{class:"hljs-function"},[s("span",{class:"hljs-params"},"file"),t(" =>")]),t(),s("span",{class:"hljs-built_in"},"console"),t(`.log(file)
...
`)])],-1),L={class:"card"},O=s("h3",null,"\u4E0A\u4F20\u9884\u5904\u7406",-1),D=s("p",null,[t("\u901A\u8FC7\u6CE8\u518C"),s("code",null,"before-read"),t("\u4E8B\u4EF6\u5BF9\u6587\u4EF6\u8FDB\u884C\u64CD\u4F5C\uFF0C\u8FD4\u56DE\u5047\u503C\u963B\u6B62\u6587\u4EF6\u8BFB\u53D6\u3002")],-1),I=s("pre",{class:"hljs"},[s("code",null,[s("link",{rel:"stylesheet",href:"./highlight.css"}),s("span",{class:"hljs-tag"},[t("<"),s("span",{class:"hljs-name"},"var-uploader"),t(),s("span",{class:"hljs-attr"},"v-model"),t("="),s("span",{class:"hljs-string"},'"files"'),t(" @"),s("span",{class:"hljs-attr"},"before-read"),t("="),s("span",{class:"hljs-string"},'"handleBeforeRead"'),t("/>")]),t(`
`)])],-1),q=s("pre",{class:"hljs"},[s("code",null,[s("link",{rel:"stylesheet",href:"./highlight.css"}),s("span",{class:"hljs-keyword"},"import"),t(" { ref } "),s("span",{class:"hljs-keyword"},"from"),t(),s("span",{class:"hljs-string"},"'vue'"),t(`

`),s("span",{class:"hljs-keyword"},"export"),t(),s("span",{class:"hljs-keyword"},"default"),t(` {
  `),s("span",{class:"hljs-function"},[s("span",{class:"hljs-title"},"setup"),t("("),s("span",{class:"hljs-params"}),t(")")]),t(` {
    `),s("span",{class:"hljs-keyword"},"const"),t(` files = ref([])

    `),s("span",{class:"hljs-keyword"},"const"),t(" handleBeforeRead = "),s("span",{class:"hljs-function"},[s("span",{class:"hljs-params"},"file"),t(" =>")]),t(" file.file.size <= "),s("span",{class:"hljs-number"},"1024"),t(" * "),s("span",{class:"hljs-number"},"10"),t(`
...
`)])],-1),G={class:"card"},H=s("h3",null,"\u7981\u7528",-1),J=s("pre",{class:"hljs"},[s("code",null,[s("link",{rel:"stylesheet",href:"./highlight.css"}),s("span",{class:"hljs-tag"},[t("<"),s("span",{class:"hljs-name"},"var-uploader"),t(),s("span",{class:"hljs-attr"},"disabled"),t(),s("span",{class:"hljs-attr"},"v-model"),t("="),s("span",{class:"hljs-string"},'"files"'),t("/>")]),t(`
`)])],-1),K={class:"card"},M=s("h3",null,"\u53EA\u8BFB",-1),Q=s("pre",{class:"hljs"},[s("code",null,[s("link",{rel:"stylesheet",href:"./highlight.css"}),s("span",{class:"hljs-tag"},[t("<"),s("span",{class:"hljs-name"},"var-uploader"),t(),s("span",{class:"hljs-attr"},"readonly"),t(),s("span",{class:"hljs-attr"},"v-model"),t("="),s("span",{class:"hljs-string"},'"files"'),t("/>")]),t(`
`)])],-1),W={class:"card"},X=s("h3",null,"\u5220\u9664\u524D\u5904\u7406",-1),Y=s("p",null,[t("\u5220\u9664\u6587\u4EF6\u4E4B\u524D\u4F1A\u89E6\u53D1"),s("code",null,"before-remove"),t("\u4E8B\u4EF6\uFF0C\u8FD4\u56DE\u5047\u503C\u963B\u6B62\u5220\u9664\u64CD\u4F5C\u3002")],-1),Z=s("pre",{class:"hljs"},[s("code",null,[s("link",{rel:"stylesheet",href:"./highlight.css"}),s("span",{class:"hljs-tag"},[t("<"),s("span",{class:"hljs-name"},"var-uploader"),t(),s("span",{class:"hljs-attr"},"v-model"),t("="),s("span",{class:"hljs-string"},'"files"'),t(" @"),s("span",{class:"hljs-attr"},"before-remove"),t("="),s("span",{class:"hljs-string"},'"handleBeforeRemove"'),t(" />")]),t(`
`)])],-1),ss=s("pre",{class:"hljs"},[s("code",null,[s("link",{rel:"stylesheet",href:"./highlight.css"}),s("span",{class:"hljs-keyword"},"import"),t(" { ref } "),s("span",{class:"hljs-keyword"},"from"),t(),s("span",{class:"hljs-string"},"'vue'"),t(`
...
`)])],-1),ts={class:"card"},es=s("h3",null,"\u81EA\u5B9A\u4E49\u4E0A\u4F20\u6837\u5F0F",-1),ds=s("pre",{class:"hljs"},[s("code",null,[s("link",{rel:"stylesheet",href:"./highlight.css"}),s("span",{class:"hljs-tag"},[t("<"),s("span",{class:"hljs-name"},"var-uploader"),t(),s("span",{class:"hljs-attr"},"v-model"),t("="),s("span",{class:"hljs-string"},'"files"'),t(">")]),t(`
...
`)])],-1),ls={class:"card"},as=s("h3",null,"\u5B57\u6BB5\u6821\u9A8C",-1),cs=s("p",null,[t("\u901A\u8FC7\u4F20\u5165\u4E00\u4E2A\u6821\u9A8C\u5668\u6570\u7EC4\u53EF\u4EE5\u5BF9\u503C\u8FDB\u884C\u6821\u9A8C\uFF0C\u6821\u9A8C\u5668\u8FD4\u56DE"),s("code",null,"true"),t("\u5219\u4E3A\u6821\u9A8C\u901A\u8FC7\u3002 \u4EE5\u5916\u7684\u503C\u5C06\u8F6C\u6362\u4E3A\u6587\u672C\u4F5C\u4E3A\u7528\u6237\u63D0\u793A\u3002 \u7B2C\u4E8C\u4E2A\u53C2\u6570\u662F\u4E00\u4E2A\u5DE5\u5177\u51FD\u6570\u96C6\u5408\uFF0C\u53EF\u4EE5\u5FEB\u901F\u83B7\u53D6\u7B26\u5408\u72B6\u6001\u7684\u6587\u4EF6\u96C6\u5408\u3002")],-1),os=s("pre",{class:"hljs"},[s("code",null,[s("link",{rel:"stylesheet",href:"./highlight.css"}),s("span",{class:"hljs-tag"},[t("<"),s("span",{class:"hljs-name"},"var-uploader"),t(`
