...
`)])],-1);function y(k,N,V,C,$,B){const t=n("var-site-code-example");return c(),r("div",d,[i,u,s("div",_,[m,l(t,null,{default:a(()=>[j]),_:1}),l(t,null,{default:a(()=>[v]),_:1})]),s("div",f,[g,x,l(t,null,{default:a(()=>[w]),_:1}),l(t,null,{default:a(()=>[b]),_:1})])])}var T=o(h,[["render",y]]);export{T as default};
