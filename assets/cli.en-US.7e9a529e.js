...
`)])],-1),D={class:"card"},M=t("h3",null,"Commands Intro",-1),B=t("h4",null,"Start the development server",-1),N=t("pre",{class:"hljs"},[t("code",null,[t("link",{rel:"stylesheet",href:"./highlight.css"}),s(`varlet-cli dev
...
`)])],-1),$=t("h4",null,"Execute unit tests in watch mode",-1),F=t("pre",{class:"hljs"},[t("code",null,[t("link",{rel:"stylesheet",href:"./highlight.css"}),s(`varlet-cli test -w
or
varlet-cli test -wa
`)])],-1),G=t("h4",null,"Lint code",-1),z=t("pre",{class:"hljs"},[t("code",null,[t("link",{rel:"stylesheet",href:"./highlight.css"}),s(`varlet-cli lint
`)])],-1),H=t("h4",null,"Lint commit message",-1),R=t("pre",{class:"hljs"},[t("code",null,[t("link",{rel:"stylesheet",href:"./highlight.css"}),s(`varlet-cli commit-lint
...
`)])],-1),ct=t("p",null,"Mount Git Hooks",-1),dt=t("pre",{class:"hljs"},[t("code",null,[t("link",{rel:"stylesheet",href:"./highlight.css"}),s(`npx simple-git-hooks
...
`)])],-1),gt=t("h4",null,"Note before release",-1),jt=t("ul",null,[t("li",null,"1.The registry of npm must set to the official npm mirror"),t("li",null,"2.The npm must execute the login command for user login")],-1);function _t(ft,bt,yt,vt,kt,xt){const e=c("var-site-code-example");return d(),r("div",h,[p,t("div",u,[m,g,l(e,null,{default:n(()=>[j]),_:1}),_]),f,t("div",b,[y,l(e,null,{default:n(()=>[v]),_:1}),k,l(e,null,{default:n(()=>[x]),_:1}),w,l(e,null,{default:n(()=>[S]),_:1}),T,l(e,null,{default:n(()=>[C]),_:1})]),t("div",D,[M,B,l(e,null,{default:n(()=>[N]),_:1}),U,l(e,null,{default:n(()=>[I]),_:1}),P,l(e,null,{default:n(()=>[V]),_:1}),A,l(e,null,{default:n(()=>[L]),_:1}),O,l(e,null,{default:n(()=>[E]),_:1}),$,l(e,null,{default:n(()=>[F]),_:1}),G,l(e,null,{default:n(()=>[z]),_:1}),H,l(e,null,{default:n(()=>[R]),_:1}),W,l(e,null,{default:n(()=>[J]),_:1}),Q,l(e,null,{default:n(()=>[q]),_:1}),K,l(e,null,{default:n(()=>[X]),_:1})]),t("div",Y,[Z,tt,l(e,null,{default:n(()=>[st]),_:1}),et,l(e,null,{default:n(()=>[lt]),_:1})]),t("div",nt,[ot,l(e,null,{default:n(()=>[at]),_:1}),ct,l(e,null,{default:n(()=>[dt]),_:1}),rt,l(e,null,{default:n(()=>[it]),_:1})]),t("div",ht,[pt,ut,l(e,null,{default:n(()=>[mt]),_:1}),gt,jt])])}var Tt=a(i,[["render",_t]]);export{Tt as default};
