...
`)])],-1),k={class:"card"},w=s("h3",null,"Load Fail",-1),x=s("p",null,[t("You can manually set the error status using "),s("code",null,"v-model:error"),t(", an error message is displayed. Clicking on the error message will help you set the "),s("code",null,"error"),t(" to "),s("code",null,"false"),t(" and trigger the "),s("code",null,"load"),t(" event again.")],-1),T=s("pre",{class:"hljs"},[s("code",null,[s("link",{rel:"stylesheet",href:"./highlight.css"}),s("span",{class:"hljs-tag"},[t("<"),s("span",{class:"hljs-name"},"var-list"),t(`
...
`)])],-1),S={class:"card"},z=s("h3",null,"Tip Text",-1),A=s("pre",{class:"hljs"},[s("code",null,[s("link",{rel:"stylesheet",href:"./highlight.css"}),s("span",{class:"hljs-tag"},[t("<"),s("span",{class:"hljs-name"},"var-list"),t(` 
