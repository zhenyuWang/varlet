...
</code></pre><p>Special note: Function components called outside the template cannot be scanned by the plug-in, and styles still need to be introduced manually. For example, <code>Snackbar</code> is a functional component.</p></div>`,4),o=[t];function c(r,i,h,d,m,u){return n(),a("div",p,o)}var f=s(l,[["render",c]]);export{f as default};
