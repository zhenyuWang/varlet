import{_ as t}from"./elevation.f7de2a7a.js";import{e as o,o as c,c as r,a as s,i as a,j as e,m as l}from"./vendor.efca09d3.js";const i={components:{}},h={class:"varlet-site-doc"},p=s("h1",null,"Custom Theme",-1),d=s("div",{class:"card"},[s("h3",null,"Intro"),s("p",null,[l("The component library uses "),s("code",null,"Less"),l(" as the CSS preprocessor and defines a number of "),s("code",null,"Less"),l(" variables in the component library Themes can be customized through plugins that modify variables at build time.")])],-1),u={class:"card"},m=s("h3",null,"Common Variables",-1),j=s("p",null,"The following are the common variables used throughout the component library. Each component has its own set of variables to replace.",-1),_=s("pre",{class:"hljs"},[s("code",null,[s("link",{rel:"stylesheet",href:"./highlight.css"}),s("span",{class:"hljs-comment"},"// text"),l(`
...
`)])],-1),b=s("div",{class:"card"},[s("h3",null,"Custom methods"),s("p",null,[l("First, make sure your build tools support "),s("code",null,"less"),l(", different ways of introducing components require different customizations, the customization methods of "),s("code",null,"Full import"),l(", "),s("code",null,"Plugin based import"),l(", "),s("code",null,"ES module based manual import"),l(" are described below.")])],-1),f={class:"card"},g=s("h3",null,"Full import",-1),v=s("pre",{class:"hljs"},[s("code",null,[s("link",{rel:"stylesheet",href:"./highlight.css"}),s("span",{class:"hljs-keyword"},"import"),l(),s("span",{class:"hljs-string"},"'@varlet/ui/es/less'"),l(`
`)])],-1),y={class:"card"},x=s("h3",null,"Plugin based import",-1),k=s("pre",{class:"hljs"},[s("code",null,[s("link",{rel:"stylesheet",href:"./highlight.css"}),s("span",{class:"hljs-comment"},"// babel.config.js"),l(`
...
`)])],-1),w={class:"card"},z=s("h3",null,"ES module based manual import",-1),V=s("pre",{class:"hljs"},[s("code",null,[s("link",{rel:"stylesheet",href:"./highlight.css"}),s("span",{class:"hljs-keyword"},"import"),l(),s("span",{class:"hljs-string"},"'@varlet/ui/es/button/style/less'"),l(`
`)])],-1),C=s("div",{class:"card"},[s("h3",null,"Modify Variables"),s("p",null,[l("Use the "),s("code",null,"modifyVars"),l(" provided by "),s("code",null,"less"),l(" for variable substitution at build time. The following is the configuration for different scenarios.")])],-1),T={class:"card"},$=s("h3",null,"Webpack",-1),S=s("p",null,[l("Here "),s("code",null,"less-loader"),l(" is used for version "),s("code",null,"< 6"),l(".")],-1),E=s("pre",{class:"hljs"},[s("code",null,[s("link",{rel:"stylesheet",href:"./highlight.css"}),s("span",{class:"hljs-comment"},"// webpack.config.js"),l(`
`),s("span",{class:"hljs-built_in"},"module"),l(`.exports = {
...
`)])],-1),N={class:"card"},B=s("h3",null,"Vue cli",-1),F=s("pre",{class:"hljs"},[s("code",null,[s("link",{rel:"stylesheet",href:"./highlight.css"}),s("span",{class:"hljs-comment"},"// vue.config.js"),l(`
`),s("span",{class:"hljs-built_in"},"module"),l(`.exports = {
...
`)])],-1),L={class:"card"},O=s("h3",null,"Vite",-1),P=s("p",null,[l("Vite do not support "),s("code",null,"~"),l(" syntax and need to override "),s("code",null,"~"),l(".")],-1),U=s("pre",{class:"hljs"},[s("code",null,[s("link",{rel:"stylesheet",href:"./highlight.css"}),s("span",{class:"hljs-comment"},"// vite.config.js"),l(`
...
`)])],-1);function q(D,H,I,M,W,A){const n=o("var-site-code-example");return c(),r("div",h,[p,d,s("div",u,[m,j,a(n,null,{default:e(()=>[_]),_:1})]),b,s("div",f,[g,a(n,null,{default:e(()=>[v]),_:1})]),s("div",y,[x,a(n,null,{default:e(()=>[k]),_:1})]),s("div",w,[z,a(n,null,{default:e(()=>[V]),_:1})]),C,s("div",T,[$,S,a(n,null,{default:e(()=>[E]),_:1})]),s("div",N,[B,a(n,null,{default:e(()=>[F]),_:1})]),s("div",L,[O,P,a(n,null,{default:e(()=>[U]),_:1})])])}var K=t(i,[["render",q]]);export{K as default};
