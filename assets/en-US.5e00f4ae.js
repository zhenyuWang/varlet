...
`)])],-1),R={class:"card"},E=s("h3",null,"Manual Control",-1),P=s("p",null,[t("Use "),s("code",null,"ref"),t(" to get countdown instance, you can call the "),s("code",null,"start"),t(", "),s("code",null,"pause"),t(", and "),s("code",null,"reset"),t(" methods.")],-1),A=s("pre",{class:"hljs"},[s("code",null,[s("link",{rel:"stylesheet",href:"./highlight.css"}),s("span",{class:"hljs-tag"},[t("<"),s("span",{class:"hljs-name"},"var-countdown"),t(`
