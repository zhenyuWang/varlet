import{_ as n}from"./elevation.f7de2a7a.js";import{e as c,o as d,c as h,a,i as l,j as e,m as s,U as o}from"./vendor.efca09d3.js";const r={components:{}},i={class:"varlet-site-doc"},p=a("h1",null,"Tabs",-1),j=a("div",{class:"card"},[a("h3",null,"Intro"),a("p",null,[s("Use "),a("code",null,"Tabs, Tab"),s(" to switch between tabbed groups and Use "),a("code",null,"TabsItems"),s(", "),a("code",null,"TabItem"),s(" to achieve view linkage with Tabs.")])],-1),b={class:"card"},v=a("h3",null,"Install",-1),m=a("pre",{class:"hljs"},[a("code",null,[a("link",{rel:"stylesheet",href:"./highlight.css"}),a("span",{class:"hljs-keyword"},"import"),s(" { createApp } "),a("span",{class:"hljs-keyword"},"from"),s(),a("span",{class:"hljs-string"},"'vue'"),s(`
...
createApp()
  ...
  .use(TabsItems)
  .use(TabItem)
`)])],-1),g={class:"card"},u=a("h3",null,"Basic Usage",-1),f=a("pre",{class:"hljs"},[a("code",null,[a("link",{rel:"stylesheet",href:"./highlight.css"}),a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"var-tabs"),s(),a("span",{class:"hljs-attr"},"v-model:active"),s("="),a("span",{class:"hljs-string"},'"active"'),s(">")]),s(`
...
`)])],-1),_=a("pre",{class:"hljs"},[a("code",null,[a("link",{rel:"stylesheet",href:"./highlight.css"}),a("span",{class:"hljs-keyword"},"import"),s(" { ref } "),a("span",{class:"hljs-keyword"},"from"),s(),a("span",{class:"hljs-string"},"'vue'"),s(`
...
`)])],-1),y={class:"card"},T=a("h3",null,"Named TAB",-1),w=a("p",null,[s("The Tabs decide which tab is activated by default by matching the "),a("code",null,"active"),s(" to the Tab\u2019s "),a("code",null,"index"),s(" You can also name a Tab by setting the "),a("code",null,"name"),s(" to the Tab, in which case the Tabs will match the name first.")],-1),k=a("pre",{class:"hljs"},[a("code",null,[a("link",{rel:"stylesheet",href:"./highlight.css"}),a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"var-tabs"),s(),a("span",{class:"hljs-attr"},"v-model:active"),s("="),a("span",{class:"hljs-string"},'"active"'),s(">")]),s(`
...
`),a("span",{class:"hljs-tag"},[s("</"),a("span",{class:"hljs-name"},"var-tabs"),s(">")]),s(`
`)])],-1),O=a("pre",{class:"hljs"},[a("code",null,[a("link",{rel:"stylesheet",href:"./highlight.css"}),a("span",{class:"hljs-keyword"},"import"),s(" { ref } "),a("span",{class:"hljs-keyword"},"from"),s(),a("span",{class:"hljs-string"},"'vue'"),s(`
...
`)])],-1),x={class:"card"},S=a("h3",null,"Modify Style",-1),D=a("pre",{class:"hljs"},[a("code",null,[a("link",{rel:"stylesheet",href:"./highlight.css"}),a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"var-tabs"),s(`
...
>`)]),s(`
  ...
  `),a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"var-tab"),s(">")]),s("Option3"),a("span",{class:"hljs-tag"},[s("</"),a("span",{class:"hljs-name"},"var-tab"),s(">")]),s(`
`),a("span",{class:"hljs-tag"},[s("</"),a("span",{class:"hljs-name"},"var-tabs"),s(">")]),s(`
`)])],-1),I={class:"card"},z=a("h3",null,"Tab Disabled",-1),V=a("pre",{class:"hljs"},[a("code",null,[a("link",{rel:"stylesheet",href:"./highlight.css"}),a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"var-tabs"),s(`
  `),a("span",{class:"hljs-attr"},"elevation"),s(`
  `),a("span",{class:"hljs-attr"},"color"),s("="),a("span",{class:"hljs-string"},'"#2979ff"'),s(`
  `),a("span",{class:"hljs-attr"},"active-color"),s("="),a("span",{class:"hljs-string"},'"#fff"'),s(`
  `),a("span",{class:"hljs-attr"},"inactive-color"),s("="),a("span",{class:"hljs-string"},'"hsla(0, 0%, 100%, .6)"'),s(`
...
`),a("span",{class:"hljs-tag"},[s("</"),a("span",{class:"hljs-name"},"var-tabs"),s(">")]),s(`
`)])],-1),A={class:"card"},P=a("h3",null,"Enable Scroll",-1),E=a("p",null,[s("Start scrolling automatically when the number of tabs is "),a("code",null,"more than four"),s(". Click the Tab to scroll automatically to the center of the viewport.")],-1),U=a("pre",{class:"hljs"},[a("code",null,[a("link",{rel:"stylesheet",href:"./highlight.css"}),a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"var-tabs"),s(`
  `),a("span",{class:"hljs-attr"},"elevation"),s(`
  `),a("span",{class:"hljs-attr"},"color"),s("="),a("span",{class:"hljs-string"},'"#2979ff"'),s(`
  `),a("span",{class:"hljs-attr"},"active-color"),s("="),a("span",{class:"hljs-string"},'"#fff"'),s(`
  `),a("span",{class:"hljs-attr"},"inactive-color"),s("="),a("span",{class:"hljs-string"},'"hsla(0, 0%, 100%, .6)"'),s(`
...
`),a("span",{class:"hljs-tag"},[s("</"),a("span",{class:"hljs-name"},"var-tabs"),s(">")]),s(`
`)])],-1),W={class:"card"},B=a("h3",null,"Tab Vertical Layout",-1),N=a("pre",{class:"hljs"},[a("code",null,[a("link",{rel:"stylesheet",href:"./highlight.css"}),a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"var-tabs"),s(`
  `),a("span",{class:"hljs-attr"},"elevation"),s(`
...
>`)]),s(`
  ...
  `),a("span",{class:"hljs-tag"},[s("</"),a("span",{class:"hljs-name"},"var-tab"),s(">")]),s(`
`),a("span",{class:"hljs-tag"},[s("</"),a("span",{class:"hljs-name"},"var-tabs"),s(">")]),s(`
`)])],-1),C=a("pre",{class:"hljs"},[a("code",null,[a("link",{rel:"stylesheet",href:"./highlight.css"}),a("span",{class:"hljs-selector-class"},".icon"),s(` {
  `),a("span",{class:"hljs-attribute"},"margin-bottom"),s(": "),a("span",{class:"hljs-number"},"5px"),s(`;
}
`)])],-1),$={class:"card"},L=a("h3",null,"Tabs Vertical Layout",-1),M=a("pre",{class:"hljs"},[a("code",null,[a("link",{rel:"stylesheet",href:"./highlight.css"}),a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"var-tabs"),s(`
...
>`)]),s(`
  ...
  `),a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"var-tab"),s(">")]),s("Option3"),a("span",{class:"hljs-tag"},[s("</"),a("span",{class:"hljs-name"},"var-tab"),s(">")]),s(`
`),a("span",{class:"hljs-tag"},[s("</"),a("span",{class:"hljs-name"},"var-tabs"),s(">")]),s(`
`)])],-1),Y=a("pre",{class:"hljs"},[a("code",null,[a("link",{rel:"stylesheet",href:"./highlight.css"}),a("span",{class:"hljs-selector-class"},".vertical-tabs"),s(` {
...
`)])],-1),R={class:"card"},H=a("h3",null,"View Relation",-1),q=a("pre",{class:"hljs"},[a("code",null,[a("link",{rel:"stylesheet",href:"./highlight.css"}),a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"var-tabs"),s(`
  `),a("span",{class:"hljs-attr"},"elevation"),s(`
  `),a("span",{class:"hljs-attr"},"color"),s("="),a("span",{class:"hljs-string"},'"#2979ff"'),s(`
  `),a("span",{class:"hljs-attr"},"active-color"),s("="),a("span",{class:"hljs-string"},'"#fff"'),s(`
  `),a("span",{class:"hljs-attr"},"inactive-color"),s("="),a("span",{class:"hljs-string"},'"hsla(0, 0%, 100%, .6)"'),s(`
...
`)])],-1),F={class:"card"},G=a("h3",null,"Sticky Layout",-1),J=a("pre",{class:"hljs"},[a("code",null,[a("link",{rel:"stylesheet",href:"./highlight.css"}),a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"var-tabs"),s(`
