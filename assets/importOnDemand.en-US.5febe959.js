import{_ as t}from"./elevation.7fcd6f98.js";import{e as o,o as c,c as p,a as s,i as e,j as a,m as n}from"./vendor.4723551d.js";const i={components:{}},r={class:"varlet-site-doc"},h=s("h1",null,"Import On Demand",-1),u=s("div",{class:"card"},[s("h3",null,"Intro"),s("p",null,"The on-demand import avoids the full import of components and can effectively reduce the size of the distribution package.")],-1),d={class:"card"},m=s("h3",null,"Manual Import",-1),_=s("p",null,[n("Each component is a "),s("code",null,"Vue plugin"),n(" and is composed of "),s("code",null,"component logic"),n(" and "),s("code",null,"style files"),n(". It is manually install and used as follows.")],-1),j=s("pre",{class:"hljs"},[s("code",null,[s("link",{rel:"stylesheet",href:"./highlight.css"}),s("span",{class:"hljs-keyword"},"import"),n(" { createApp } "),s("span",{class:"hljs-keyword"},"from"),n(),s("span",{class:"hljs-string"},"'vue'"),n(`
...
`)])],-1),k=s("h4",null,"Vue Cli",-1),w=s("pre",{class:"hljs"},[s("code",null,[s("link",{rel:"stylesheet",href:"./highlight.css"}),s("span",{class:"hljs-comment"},"// vue.config.js"),n(`
...
`)])],-1),C=s("p",null,[n("Special note: Function components called outside the template cannot be scanned by the plug-in, and styles still need to be introduced manually. For example, "),s("code",null,"Snackbar"),n(" is a functional component.")],-1);function B(D,A,U,R,$,N){const l=o("var-site-code-example");return c(),p("div",r,[h,u,s("div",d,[m,_,e(l,null,{default:a(()=>[j]),_:1})]),s("div",g,[f,v,e(l,null,{default:a(()=>[y]),_:1}),k,e(l,null,{default:a(()=>[w]),_:1}),b,e(l,null,{default:a(()=>[x]),_:1}),I,e(l,null,{default:a(()=>[V]),_:1}),C])])}var q=t(i,[["render",B]]);export{q as default};
